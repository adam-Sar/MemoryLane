...
<head>
    ...
    <title>GameRecovery - Login</title>
    ...
    <div class="auth-container">
        ...
        <div class="auth-card">
            <div style="text-align: center; margin-bottom: 2rem; position: relative; z-index: 1;">
                ...
                <p style="color: var(--text-muted); font-size: 0.9rem;">Sign in to continue your journey</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST" style="position: relative; z-index: 1;">
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.5rem;">
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer; color: var(--text-muted); font-size: 0.9rem;">
                        <input type="checkbox" name="remember" style="accent-color: var(--neon-cyan);">
                        Remember me
                    </label>
                    <a href="#" style="color: var(--neon-cyan); font-size: 0.9rem; font-weight: 600; text-decoration: none; transition: all 0.3s;">
                        Forgot password?
                    </a>
                </div>
            ...
            <div style="text-align: center; margin-top: 2rem; position: relative; z-index: 1;">
                <p style="color: var(--text-muted); font-size: 0.9rem;">
                    New player? 
                    <a href="{{ route('register') }}" style="color: var(--neon-cyan); font-weight: 700; text-decoration: none; transition: all 0.3s;">
                        Create Account →
                    </a>
                </p>
            </div>
        ...
        <div style="text-align: center; margin-top: 2rem; position: relative; z-index: 1;">
            <div style="display: flex; justify-content: center; gap: 2rem; margin-bottom: 1rem;">
                <a href="{{ route('home') }}" style="color: var(--text-muted); font-size: 0.85rem; text-decoration: none; transition: all 0.3s; hover: color: var(--neon-cyan);">
                    Home
                </a>
